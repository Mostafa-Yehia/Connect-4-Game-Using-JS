...
init = function(e) {
		...
		if (parseInt(tos[temp]) < 6) {
			...
			if (!win) {
				if (turn == 0) {turn = 1; p2turn.style.border = '1px solid red'; p1turn.style.border = '';  }
				else {turn = 0; p1turn.style.border = '1px solid red'; p2turn.style.border = '' ; }
			}
			else {
			...
			//alert("wooow: " + players[turn].innerText + " won !!!")
				end()
			}
		}
		else {
